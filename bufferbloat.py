...
class BBTopo(Topo):
    ...
    def build(self, n=2):
        ...
        self.addLink(switch, second_host, bw=1.5, delay='10ms', max_queue_size=100)
...
def bufferbloat():
    ...
    for _ in range(3):
        second_host.cmd('curl -o /dev/null -s -w "Time: \\{time_total\\}\\n" http://{}:80/index.html >> download_times.txt'.format(first_host.IP()))
